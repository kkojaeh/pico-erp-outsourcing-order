...
class OutsourcingOrderPrinterSpec extends Specification {

  @Autowired
  OutsourcingOrderService orderService

  def id = OutsourcingOrderId.from("outsourcing-order-a")
  ...
  def printOrder() {
    return orderService.printDraft(new OutsourcingOrderRequests.PrintDraftRequest(
      id: id
    ))
  }
