...
import pico.erp.outsourcing.order.OutsourcingOrderView.Filter;
import pico.erp.outsourcing.order.item.QOutsourcingOrderItemEntity;
...
@Validated
public class OutsourcingOrderQueryJpa implements OutsourcingOrderQuery {


  private final QOutsourcingOrderEntity order = QOutsourcingOrderEntity.outsourcingOrderEntity;

  private final QOutsourcingOrderItemEntity orderItem = QOutsourcingOrderItemEntity.outsourcingOrderItemEntity;
  ...
  @Override
  public Page<OutsourcingOrderView> retrieve(Filter filter, Pageable pageable) {
    val query = new JPAQuery<OutsourcingOrderView>(entityManager);
    val select = Projections.bean(OutsourcingOrderView.class,
      order.id,
      order.code,
      order.chargerId,
      order.receiverId,
