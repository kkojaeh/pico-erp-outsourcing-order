...
@Entity(name = "OutsourcingOrderMaterial")
@Table(name = "OSO_OUTSOURCING_ORDER_MATERIAL", indexes = @Index(columnList = "ORDER_ID"))
@Data
...
@NoArgsConstructor
@Builder
public class OutsourcingOrderMaterialEntity implements Serializable {
